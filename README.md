...
The newly launched Vertical series offers a different ordering experience, the main difference being the integration of products and pricing information, providing fully dynamic product and price data, allowing for closer alignment with customer needs and faster responses.  Firstly, KKday B2D launched the **Japan Railways (JR)** service, the only platform in the Asian-Pacific market offering peer ordering; refer to the new specifications, Vert-JR API (<a href="https://api-b2d.kkday.com/vert/jr/Redoc">link</a>).
